...
//    void UpdateWalking()
//    {
//        bool sprinting = Input.GetKey(KeyCode.RightShift) || Input.GetKey(KeyCode.LeftShift);

//        yVel += gravity * Time.deltaTime;
//        if (isGrounded && Input.GetKey(KeyCode.Space))
//            yVel = jumpForce;

//        Vector3 updateVel = (transform.right * Input.GetAxis("Horizontal") + transform.forward * Input.GetAxis("Vertical") * (sprinting ? 1.5f : 1f)) * speed;
