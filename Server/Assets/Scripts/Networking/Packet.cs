...
public class Packet : IDisposable
{
    ...
    /// <param name="value">The Guid to insert.</param>
    public void InsertGuid(Guid value)
    {
        buffer.InsertRange(0, value.ToByteArray());  // Insert the Guid at the start of the buffer
    }
    ...
    {
        return new Guid(ReadBytes(16, moveReadPos));
    }
    #endregion
